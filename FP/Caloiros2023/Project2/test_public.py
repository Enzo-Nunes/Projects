...
class TestPublicIntersecao:
    ...
    def test_2(self):
        assert not fp.intersecoes_iguais(fp.cria_intersecao('A', 2), fp.cria_intersecao('B', 13))

    def test_3(self):
        assert fp.intersecoes_iguais(fp.cria_intersecao('A', 2), fp.str_para_intersecao('A2'))
    ...
    def test_5(self):
        ...
        assert ('A1', 'B2', 'A3') == tuple(fp.intersecao_para_str(i) for i in fp.obtem_intersecoes_adjacentes(i1, fp.cria_intersecao('S',19)))
        
    def test_6(self):
        tup = (fp.cria_intersecao('A',1), fp.cria_intersecao('A',3), fp.cria_intersecao('B',1), fp.cria_intersecao('B',2))
        assert ('A1', 'B1', 'B2', 'A3') == tuple(fp.intersecao_para_str(i) for i in fp.ordena_intersecoes(tup))
 ...
 1 . . O . . . . . .  1
   A B C D E F G H I"""
    ...
    def test_6(self):
        ...
        assert tuple(fp.intersecao_para_str(i) for i in liberdades) == ('E3', 'F3', 'G4', 'D5', 'G5', 'E6', 'F6')
    ...
    def test_7(self):
        ...
        assert tuple(fp.intersecao_para_str(i) for i in terr[0]) == ('A1', 'B1', 'A2', 'B2')
    ...
    def test_8(self):
        ...
        assert  tuple(fp.intersecao_para_str(i) for i in border) == ('C1', 'C2', 'A3', 'B3')
...
class TestPublicTurnoJogador:
    def test_1(self):
        ...
        assert turno_jogador_offline(g, fp.cria_pedra_preta(), fp.cria_goban_vazio(9), 'B10\nB2\nG5\n') == ref

    def test_2(self):
        ib = tuple(fp.str_para_intersecao(i) for i in ('C1', 'C2', 'C3', 'D2', 'D3', 'D4', 'A3', 'B3'))
        ip = tuple(fp.str_para_intersecao(i) for i in ('A1', 'A2', 'B1', 'E4', 'E5', 'F4', 'F5', 'G6', 'G7'))
        g = fp.cria_goban(9, ib, ip)
        turno_jogador_offline(g, fp.cria_pedra_preta(), fp.cria_goban_vazio(9), 'B10\nB2\nG5\n')
        ref = \
"""   A B C D E F G H I
 9 . . . . . . . . .  9
 8 . . . . . . . . .  8
...
ib = 'C2', 'D2', 'E2', 'F2', 'G2', 'H2', 'I2', 'B3', 'J3', 'B4', 'D4', 'E4', 'F4', 'B5', 'D5', 'G5', 'J5', 'B6', 'D6', 'E6', 'F6', 'G6', 'H6', 'J6', 'C7', 'J7', 'C8', 'D8', 'E8', 'F9', 'G9', 'H9', 'I9'
ip = 'C3', 'D3', 'E3', 'F3', 'G3', 'C4', 'G4', 'H4', 'C5', 'H5', 'C6', 'H6', 'D7', 'E7', 'F7', 'G7', 'H7', 'I7'
