...
public class Calculator {
	 ...
	 *
	 * @returns the current spreadsheet of this application. This reference can
	 *     be null.
	 */
	public final Spreadsheet getSpreadsheet() { return _spreadsheet; }
	...
	public void importFile(String filename) throws ImportFileException {
		try {
			// FIXME open import file and feed entries to new spreadsheet (in a
			// cycle)
			//       each entry is inserted using insertContent of Spreadsheet.
			//       Set new
			// spreadsheet as the active one.
			// ....
		} catch (
			IOException |
			UnrecognizedEntryException /* FIXME maybe other exceptions */ e) {
